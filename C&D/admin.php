...
<br><table id="Table_01" width="800" height="295" border="0" cellpadding="0" cellspacing="0" align="center">
	...
	<tr>
	  <td colspan="3" valign="top"> select the user ID which you want to confirm
<form action="adminconfirm.php" name="form1" method="post">
<table border="1">
<tr>
<td> Name</td>
<td> Family name</td>
...
$sql = mysql_query("SELECT * FROM user WHERE docchecked = 'yes' AND confirmed ='no'");
...
click <a href="adminuserselect.php">here</a> to edit users</td>
	</tr>
</table>
